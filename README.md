...
The system is deployed locally via an interactive **Streamlit** dashboard, allowing users to either simulate custom weather scenarios or pull live meteorological feeds from Open-Meteo.
...
* **Interactive UI**: Built with Streamlit to deliver live meteorological telemetry, real-time hazard calculations, and dynamic risk indicators.
...
Dust-Storm-App/
│
├── app.py                     # Streamlit frontend and live prediction engine
├── kuwait_dust_radar.json     # Trained XGBoost model weights
